...
chat_history = Text(root, height=30, width=97, font=font.Font(family="Google Sans"), bg=background_color, fg=text_color,
                    state="disabled")
...
for option in ai_options:
    radio_button = Radiobutton(sidebar, text=option, variable=selected_ai_var, value=ai_models[option],
                               command=lambda ai=option: change_ai(ai), bg=background_color, fg=text_color,
                               selectcolor=primary_color, activebackground=background_color,
                               activeforeground=text_color, font=font.Font(family="Google Sans"), width=25, anchor="n")
...
user_input = Entry(root, width=93, font=font.Font(family="Google Sans"), bg=background_color, fg="gray",
...
send_button = Button(root, image=send_icon, command=lambda: send_message(current_ai), borderwidth=0,
                     bg=background_color)
